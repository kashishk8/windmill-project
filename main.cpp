...
void powerstation()
{
	...
	glBegin(GL_POLYGON);//bottom part of powerstation(anti clockwise)
	glVertex2i(ax,ay);//a
...
{   GLint ax=28,ay=30;
	...
	glBegin(GL_POLYGON);//bottom part of fan house (anti clockwise)
	glVertex2i(ax,ay);//a
	...
	glBegin(GL_POLYGON);//roof  upper part of fan house(from a)
	glVertex2i(ax,ay+3);//a
...
{
    printf("**\n");
    printf(" User Manual - to operate with this app use instructions below:-        ");
    printf("\n**");
